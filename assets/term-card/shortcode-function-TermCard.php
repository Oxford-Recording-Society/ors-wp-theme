            ...
            for ($i = 0; $i < 64; $i++) {
                ...
                if ($i % 8 == 0) {
                    ...
                    foreach ( $events_array[$day_count] as $event ) {
                        ...
                        $html_output .= "<div class= '$descriptors[0] $descriptors[1]'>"
                            . ($event[link] !== '' ? "<a href='$event[link]' target='_blank'>$event[title]</a>"
                                : $event[title])
                            .  "<br>$event[start_time]-$event[end_time] <br>
                            <p style='font-size: 75%;'>$topic_text[$topic]</p><div class='boxlabel'
